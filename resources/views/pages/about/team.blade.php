                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Industry Expertise @else Keahlian Industri @endif</h4>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Fast Response @else Respon Cepat @endif</h4>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Customer Focus @else Fokus Pelanggan @endif</h4>
