                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="https://wa.me/?text={{ urlencode($articleTitle . ' - ' . $canonicalUrl) }}" 
                                   target="_blank" rel="noopener noreferrer"
                                   class="w-9 h-9 flex items-center justify-center rounded-lg bg-green-700 text-white hover:bg-green-800 transition-colors"
                        ...
                        <div class="mt-6 p-5 bg-white rounded-xl border border-gray-100 shadow-sm">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <h2 class="font-semibold text-gray-900">{{ $article->author->name }}</h2>
