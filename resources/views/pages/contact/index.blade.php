        ...
        <div class="container relative z-10">
            ...
            <div class="max-w-4xl">
                ...
                <div class="flex flex-wrap gap-4 mt-8">
                    ...
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $socialLinks['whatsapp']) }}?text={{ urlencode(__('Hello, I would like to ask about your products.')) }}" target="_blank" 
                        class="inline-flex items-center gap-2 bg-green-700 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-800 transition-all hover:scale-105">
        ...
        <div class="container">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group bg-gradient-to-br from-primary-50 to-white rounded-2xl p-6 border border-primary-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h2 class="font-bold text-lg text-gray-900 mb-2">@if(app()->getLocale() === 'en') Call Us @else Telepon Kami @endif</h2>
                ...
                <div class="group bg-gradient-to-br from-green-50 to-white rounded-2xl p-6 border border-green-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h2 class="font-bold text-lg text-gray-900 mb-2">WhatsApp</h2>
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $socialLinks['whatsapp'] ?? $companyInfo['whatsapp'] ?? '') }}?text={{ urlencode(__('Hello, I would like to ask about your products.')) }}" target="_blank" class="text-green-700 hover:text-green-800 font-medium">
                ...
                <div class="group bg-gradient-to-br from-secondary-50 to-white rounded-2xl p-6 border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h2 class="font-bold text-lg text-gray-900 mb-2">Email</h2>
                    <x-protected-email 
                ...
                <div class="group bg-gradient-to-br from-accent-50 to-white rounded-2xl p-6 border border-accent-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h2 class="font-bold text-lg text-gray-900 mb-2">@if(app()->getLocale() === 'en') Visit Us @else Kunjungi Kami @endif</h2>
                            ...
                            <div class="flex items-start gap-4 p-4 bg-white rounded-xl border border-gray-100 hover:shadow-md transition-shadow">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-sm mt-1">
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $socialLinks['whatsapp']) }}?text={{ urlencode(__('Hello, I would like to ask about your products.')) }}" target="_blank" class="hover:text-green-600 transition-colors flex items-center gap-1">
