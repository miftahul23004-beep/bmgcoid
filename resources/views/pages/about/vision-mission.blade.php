                ...
                <div class="relative order-2 lg:order-1">
                    <div class="relative">
                        ...
                        <div class="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden shadow-2xl">
                            <img src="/images/about/vision.jpg" alt="Visi Perusahaan" class="w-full h-full object-cover" width="800" height="600" onerror="this.src='https://placehold.co/800x600/1E40AF/ffffff?text=Our+Vision'">
                        </div>
