            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="relative">
                    <div class="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden shadow-2xl">
                        ...
                        @endphp
                        <img src="{{ $certImage }}" alt="Certificates" class="w-full h-full object-cover" width="800" height="600" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/800x600/1E40AF/ffffff?text=Certified+Quality'">
                    </div>
                    {{-- Floating Badge --}}
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Quality Guarantee @else Jaminan Kualitas @endif</h3>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Legal Transactions @else Transaksi Legal @endif</h3>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-lg text-gray-900 mb-1">@if(app()->getLocale() === 'en') Tender Ready @else Siap Tender @endif</h3>
        ...
        <div class="container relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    @php $socialLinks = app(\App\Services\SettingService::class)->getSocialLinks(); @endphp
                    @if(!empty($socialLinks['whatsapp']))
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $socialLinks['whatsapp']) }}?text={{ urlencode(__('Hello, I would like to ask about your products.')) }}" target="_blank" class="inline-flex items-center gap-2 bg-green-700 text-white px-8 py-4 rounded-xl font-semibold hover:bg-green-800 transition-all hover:shadow-xl hover:scale-105">
