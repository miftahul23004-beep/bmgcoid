            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                            ...
                            <div class="flex md:hidden gap-2 mt-4 overflow-x-auto pb-2 scrollbar-hide">
                                <template x-for="(media, index) in mediaList" :key="'mobile-' + index">
                                    ...
                                    >
                                        ...
                                        <template x-if="media.type === 'video' || media.type === 'youtube'">
                ...
                <div class="product-info">
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('social.whatsapp') ?? '6281234567890') }}?text={{ urlencode(__('Hello, I am interested in') . ' ' . $product->getTranslation('name', 'id') . ' (SKU: ' . ($product->sku ?? '-') . ')') }}" target="_blank" rel="noopener" class="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white text-lg font-semibold px-8 py-4 rounded-xl transition-colors">
