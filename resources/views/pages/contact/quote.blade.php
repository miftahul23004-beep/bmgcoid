...
@section('content')
        ...
        <div class="container relative z-10">
            <nav class="text-sm mb-6" aria-label="Breadcrumb">
                <ol class="flex items-center gap-2">
                    <li><a href="{{ route('home') }}" class="text-secondary-100 hover:text-white transition-colors">{{ __('Home') }}</a></li>
            ...
            <div class="max-w-4xl">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold font-heading mb-6 leading-tight">
                    @if(app()->getLocale() === 'en')
                        Request a <span class="text-white/80">Quote</span>
                    @else
                        Minta <span class="text-white/80">Penawaran</span>
                    @endif
                </h1>
                    ...
                    <div class="sticky top-24 space-y-6">
                        ...
                        <div class="bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-2xl shadow-sm p-6 text-white">
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $socialLinks['whatsapp']) }}" target="_blank" class="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-xl hover:bg-white/20 transition-all">
    ...
    <script>
        function quoteForm() {
            return {
                selectedProducts: @json(old('products', request('product') ? [request('product')] : [])),
                updateProducts() {
