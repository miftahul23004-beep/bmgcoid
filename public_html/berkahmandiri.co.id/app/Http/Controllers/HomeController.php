...
class HomeController extends Controller
{
    ...
    {
        // Cache homepage data for 5 minutes to reduce TTFB
        ...
        // Pass first hero image for preloading (LCP optimization)
        if (isset($data['heroSlides']) && $data['heroSlides']->count() > 0) {
            $data['heroImage'] = $data['heroSlides']->first()->image_url;
        }
