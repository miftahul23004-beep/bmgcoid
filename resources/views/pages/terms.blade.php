        ...
        <div class="container">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 text-sm">@if(app()->getLocale() === 'en') Legally Binding @else Mengikat Secara Hukum @endif</h3>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 text-sm">@if(app()->getLocale() === 'en') Clear Terms @else Ketentuan Jelas @endif</h3>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 text-sm">@if(app()->getLocale() === 'en') Fair Practice @else Praktik Adil @endif</h3>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="font-semibold text-gray-900 text-sm">@if(app()->getLocale() === 'en') Indonesian Law @else Hukum Indonesia @endif</h3>
                </div>
            </div>
        </div>
    </section>
