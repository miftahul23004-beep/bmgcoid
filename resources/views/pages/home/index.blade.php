        ...
        <div class="container relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    <a href="https://wa.me/{{ $whatsappNumber }}" target="_blank" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold transition-all hover:shadow-2xl hover:scale-105 text-lg border-2 border-green-700 hover:border-green-800">
