            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="relative">
                    <div class="aspect-w-4 aspect-h-3 rounded-2xl overflow-hidden shadow-2xl">
                        ...
                        @endphp
                        <img src="{{ $teamWorkImage }}" alt="Team Work" class="w-full h-full object-cover" width="800" height="600" loading="lazy" decoding="async" onerror="this.src='https://placehold.co/800x600/1E40AF/ffffff?text=Team+Work'">
                    </div>
                    {{-- Floating Stats --}}
