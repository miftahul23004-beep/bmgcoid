...
<head>
    ...
    {{-- Fonts with display=swap - loaded async for better LCP --}}
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&family=Plus+Jakarta+Sans:wght@600;700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
    ...
    {{-- Critical CSS for preventing CLS and faster FCP --}}
    <style>
        /* Critical CSS - Inline for faster First Contentful Paint */
        [x-cloak] { display: none !important; }
        
        /* Base styles for preventing layout shift */
        body {
        ...
        .topbar { min-height: 36px; background: #0F172A; }
        .navbar { min-height: 64px; background: white; }
        
        /* Hero section placeholder */
        .hero-section { min-height: 400px; }
        
        /* Image aspect ratios to prevent CLS */
        ...
        .invisible-until-css { visibility: hidden; }
        
        /* Button minimum sizes for accessibility */
        button, [role="button"], a.btn { min-height: 44px; min-width: 44px; }
    </style>
